<!-- start chapter page -->
        <div class="chapter">
            <?php if ($id > 1): ?>
            <a href="<?= $router->generate('chapter', ['id' => ($id - 1)] ) ?>" alt="Previous chapter">
            ...
            <a href="<?= $router->generate('chapter', ['id' => ($id + 1)] ) ?>" alt="Next chapter">
        ...
        <div class="novel">
            ...
            <ul class="buttonbar">
                <a id="next-chapter" href="<?= $router->generate('chapter', ['id' => ($id + 1)] ) ?>" alt="Next chapter">
                <li>
