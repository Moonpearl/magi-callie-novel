...
$filename = 'https://docs.google.com/document/d/e/2PACX-1vSCBRPEi6JYPUH9kuKlw8qrFxGJIHhWRSoFN2VmAbvHefrkw8D9gepiDQMc8UCcUki1ATziApu05wG6/pub?embedded=true';

$content = file_get_contents($filename);
// Remove Google styles
$content = preg_replace("/\<style type=\"text\/css\"\>.*?\<\/style\>/", '', $content);
// Add CSS link
$content = str_replace('</head>', '<link rel="stylesheet" href="../css/reset.css" />'.PHP_EOL.'<link rel="stylesheet" href="test.css" />'.PHP_EOL.'</head>', $content);
// 
